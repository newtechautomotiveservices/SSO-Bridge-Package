...
Route::group(['middleware' => ['web']], function () {
    Route::get(config('ssobridge.sso.login_route'), 'Newtech\SSOBridge\SSOBridgeController@indexLogin');
	Route::get(config('ssobridge.sso.logout_route'), 'Newtech\SSOBridge\SSOBridgeController@indexLogout');
